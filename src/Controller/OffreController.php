...
class OffreController extends AbstractController
{
    ...
    #[Route('/front/{id}', name: 'app_offre_front', methods: ['GET'])]
    public function front($id,Request $request,OffreRepository $offreRepository, PaginatorInterface $paginator): Response
    {

        return $this->render('offre/front.html.twig', [
